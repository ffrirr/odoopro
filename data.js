...
export const TOPICS = [
  ...
  { id: "marketing", nama: "Marketing", icon: "megaphone", soalCount: 6 },
  { id: "website", nama: "Website", icon: "globe", soalCount: 11 },
  { id: "ecommerce", nama: "eCommerce", icon: "shopping-bag", soalCount: 8 },
  { id: "knowledge", nama: "Knowledge", icon: "book", soalCount: 6 },
  { id: "project", nama: "Project", icon: "clipboard", soalCount: 18 },
  { id: "timesheets", nama: "Timesheets", icon: "clock", soalCount: 6 },
  { id: "accounting", nama: "Accounting", icon: "dollar-sign", soalCount: 28 },
